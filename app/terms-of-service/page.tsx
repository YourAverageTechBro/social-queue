    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          account to use certain features of Social Queue. You agree to provide
          accurate and complete information during the registration process and
          to keep your account information up to date.
        </li>
        <li className="mb-2">
          <strong>User Conduct:</strong> You agree not to use Content Marketing
          Blueprint for any unlawful purpose or in any manner that could damage,
          disable, overburden, or impair the product.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">
          <strong>Ownership:</strong> YK Labs LLC owns all intellectual property
          rights in Social Queue, including its content, design, and
          functionality.
        </li>
        <li className="mb-2">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          Blueprint, you grant us a non-exclusive, worldwide, royalty-free, and
          transferable license to use, reproduce, modify, distribute, and
          display your content as necessary to provide and improve the product.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">
          <strong>Fees:</strong> If Social Queue offers subscription plans, you
          agree to pay the fees associated with your chosen plan. All fees are
          non-refundable unless otherwise stated.
        </li>
        <li className="mb-2">
          <strong>Billing:</strong> Subscription fees will be billed in advance,
          and your subscription will renew automatically unless you cancel it.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">
          ...
          following the instructions provided in Social Queue.
        </li>
        <li className="mb-2">
          <strong>By Us:</strong> We reserve the right to terminate your account
          or suspend your access to Social Queue at our discretion, without
      ...
      <p>
        By using Social Queue, you acknowledge that you have read and understood
        these Terms of Service and agree to be bound by them. Thank you for
        choosing Social Queue.
      </p>
    </div>
  );
};
