  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        ...
        with the terms of this policy, please do not access or use the product.
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          access and use Social Queue, including IP address, browser type,
          device type, and usage patterns.
        </li>
        <li className="mb-2">
          <strong>Cookies and Similar Technologies:</strong> We use cookies and
          similar technologies to enhance your experience and track your usage
          of the product.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">
          ...
          provide, maintain, and improve Social Queue, including troubleshooting
          issues and personalizing your experience.
        </li>
        <li className="mb-2">
          For communication: We may use your contact information to communicate
          with you about your account, updates to Social Queue, and marketing
          promotions.
        </li>
        <li className="mb-2">
          To comply with legal obligations: We may process your data as required
      ...
      <p className="mb-4">
        ...
        than the one in which you reside. These countries may have different
        data protection laws. We take appropriate measures to ensure your
      ...
      <p className="mb-4">
        Social Queue is not intended for individuals under the age of 18. We do
      ...
      <p>
        ...
        this Privacy Policy and agree to its terms. Thank you for trusting us
